...
//获取屏幕宽度，高度
#define SCREEN_WIDTH_BinBear ([UIScreen mainScreen].bounds.size.width)
#define SCREEN_HEIGHT_BinBear ([UIScreen mainScreen].bounds.size.height)
